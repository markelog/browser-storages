...
<dd>Существует распространенное заблуждение – localStorage записывает и читает данные напрямую на жестким диск, это не так, на сколько мне известно, ни одна имплементация localStorage'а не работает таким образом, запись и чтение происходит в память, это происходить или
<ol>
